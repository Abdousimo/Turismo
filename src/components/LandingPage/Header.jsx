    ...
    return (
        <section className='w-full bg-transparent flex flex-col'>
            ...
            <div id='Hero'  className="w-full h-[770px] z-0 flex justify-center items-start pt-20">
                <Link href={'/User'} className='flex items-center justify-center w-[226px] h-[55px] bg-[#FFC100] hover:bg-[#FFC444] font-bold text-[#fff] text-xl rounded-2xl'>LET'S TRAVEL</Link>
            </div>
        </section>
    );
}
