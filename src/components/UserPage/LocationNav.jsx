...
function LocationNav(props) {
    ...
    return (
        ...
        <section className='w-full h-14 flex items-center gap-2 pl-24 bg-[#EEEEEE99]'>
           ...
           <Link href={'/User'} className='text-[#003554] font-OPENSANS font-bold pb-1 hover:border-b-[#003554] hover:border-b-2' onClick={()=> {window.localStorage.setItem("Temporary_Place",null),window.localStorage.setItem("Places",null)}}>Tourisme</Link>
           <span className='text-[#003554] font-OPENSANS font-bold'><AiOutlineRight size={20}/></span>
           <div>
